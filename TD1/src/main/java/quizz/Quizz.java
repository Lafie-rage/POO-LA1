...
public class Quizz {
    ...
    public Quizz() {
        ...
        partie = new Partie(nbQuestions, playerName);

        List<JSONObject> jsonObjects = new ArrayList<>();


        partie.setCategories(retrieveCategories(jsonObjects));

        Categorie categorie = getChoosenCategory();

        askQuestions(categorie.getQuestions(partie.getNbQuestions()));
    ...
    private static List<Categorie> retrieveCategories(List<JSONObject> jsonObjects) {
        ...
        for (JSONObject json : jsonObjects)
            categories.add(new Categorie(json.get("thème").toString(), json));
        return categories;
    }

    private static Categorie getChoosenCategory() {
        List<Categorie> categories = partie.getCategories();
